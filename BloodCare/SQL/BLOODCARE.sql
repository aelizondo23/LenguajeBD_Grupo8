...
VALUES ('101010101', 'Andrea', 'Mora Salazar', 'San Jose , Rohrmoser', TO_DATE('1991-04-15','YYYY-MM-DD'), 'F', '8888-1010', 'andrea.mora@example.com', 1);

INSERT INTO donante (id_donante, nombre, apellido, direccion, fecha_nacimiento, sexo, telefono, correo, id_tipo_sangre)
VALUES ('202020202', 'Luis', 'Cordero Jimenez', 'Cartago, El Guarco', TO_DATE('1989-06-22','YYYY-MM-DD'), 'M', '8899-2020', 'luis.cordero@example.com', 2);

INSERT INTO donante (id_donante, nombre, apellido, direccion, fecha_nacimiento, sexo, telefono, correo, id_tipo_sangre)
VALUES ('303030303', 'Maria Jose ', 'Solis Vargas', 'Alajuela, San Rafael', TO_DATE('1993-12-09','YYYY-MM-DD'), 'F', '8700-3030', 'mariaj.solis@example.com', 3);

INSERT INTO donante (id_donante, nombre, apellido, direccion, fecha_nacimiento, sexo, telefono, correo, id_tipo_sangre)
VALUES ('404040404', 'Jorge', 'Rodriguez  Alvarez', 'Heredia, Barva', TO_DATE('1990-01-30','YYYY-MM-DD'), 'M', '8711-4040', 'jorge.r@example.com', 4);

INSERT INTO donante (id_donante, nombre, apellido, direccion, fecha_nacimiento, sexo, telefono, correo, id_tipo_sangre)
VALUES ('505050505', 'Paola', 'Zuniga Chacon', 'San Jose , Curridabat', TO_DATE('1987-10-18','YYYY-MM-DD'), 'F', '8722-5050', 'paola.z@example.com', 5);

INSERT INTO donante (id_donante, nombre, apellido, direccion, fecha_nacimiento, sexo, telefono, correo, id_tipo_sangre)
VALUES ('606060606', 'Carlos', 'Alpizar Marin', 'Puntarenas, Parrita', TO_DATE('1995-07-11','YYYY-MM-DD'), 'M', '8733-6060', 'carlos.alpizar@example.com', 6);

INSERT INTO donante (id_donante, nombre, apellido, direccion, fecha_nacimiento, sexo, telefono, correo, id_tipo_sangre)
VALUES ('707070707', 'Estefany', 'Lopez Valverde', 'Guanacaste, Santa Cruz', TO_DATE('1992-03-26','YYYY-MM-DD'), 'F', '8744-7070', 'estefany.g@example.com', 7);

INSERT INTO donante (id_donante, nombre, apellido, direccion, fecha_nacimiento, sexo, telefono, correo, id_tipo_sangre)
VALUES ('808080808', 'Jose  Miguel', 'Sanchez Rivera', 'Limon, Siquirres', TO_DATE('1988-09-14','YYYY-MM-DD'), 'M', '8755-8080', 'jose.sanchez@example.com', 8);
...
-- Insertar centros de donacion
INSERT INTO centro_donacion (nombre, ubicacion, tipo)
VALUES ('Hospital San Vicente de Paul', 'Heredia centro', 'Fijo');

INSERT INTO centro_donacion (nombre, ubicacion, tipo)
VALUES ('Empresa Cerveceria de Costa Rica', 'Heredia Centro, Heredia', 'Movil');

INSERT INTO centro_donacion (nombre, ubicacion, tipo)
VALUES ('Campana Universitaria', 'UCR Sede Rodrigo Facio', 'Campana');


-- componente_sanguineo
INSERT INTO componente_sanguineo (nombre, descripcion) 
VALUES ('Globulos Rojos', 'Transportan oxigeno desde los pulmones al resto del cuerpo y dioxido de carbono de vuelta a los pulmones.');
...
INSERT INTO causa_rechazo (descripcion) VALUES ('Presión arterial fuera de rango');
INSERT INTO causa_rechazo (descripcion) VALUES ('Nivel bajo de hemoglobina');
INSERT INTO causa_rechazo (descripcion) VALUES ('Resfriado o enfermedad reciente');
INSERT INTO causa_rechazo (descripcion) VALUES ('Consumo de alcohol en las últimas 24 horas');
INSERT INTO causa_rechazo (descripcion) VALUES ('Tatuaje o perforación reciente');
INSERT INTO causa_rechazo (descripcion) VALUES ('Viaje reciente a zona endémica de malaria');
INSERT INTO causa_rechazo (descripcion) VALUES ('Uso de medicamentos incompatibles');
INSERT INTO causa_rechazo (descripcion) VALUES ('Peso corporal insuficiente');
INSERT INTO causa_rechazo (descripcion) VALUES ('Infección activa o heridas abiertas');
INSERT INTO causa_rechazo (descripcion) VALUES ('Antecedentes de enfermedades transmisibles');
...
BEGIN
  UPDATE donacion SET
    ...
    id_usuario_registra = p_id_usuario 
...
CREATE OR REPLACE PROCEDURE eliminar_rechazo (
  p_id_rechazo IN NUMBER,
...
CREATE OR REPLACE PROCEDURE listar_rechazos (
...
CREATE OR REPLACE PROCEDURE obtener_rechazo (
  p_id_rechazo IN NUMBER,
  p_cursor OUT SYS_REFCURSOR
) IS
BEGIN
...
CREATE OR REPLACE PROCEDURE obtener_total_componentes (
  p_cursor OUT SYS_REFCURSOR
) IS
BEGIN
  OPEN p_cursor FOR
    SELECT 
      ...
      NVL(SUM(dc.unidades), 0) AS total_unidades
    FROM componente_sanguineo c
    LEFT JOIN donacion_componente dc 
      ON c.id_componente = dc.id_componente
    GROUP BY c.id_componente, c.nombre
    ORDER BY c.nombre;
END;
/
-- Funciones
...
CREATE OR REPLACE PACKAGE pkg_donacion AS
  ...
  PROCEDURE eliminar_donacion(
    p_id_donacion        IN donacion.id_donacion%TYPE,
    p_id_usuario         IN donacion.id_usuario_registra%TYPE
  );
  
  PROCEDURE actualizar_donacion(
    p_id_donacion        IN donacion.id_donacion%TYPE,
    p_id_donante         IN donacion.id_donante%TYPE,
    p_id_centro          IN donacion.id_centro%TYPE,
    p_fecha              IN donacion.fecha%TYPE,
  ...
  PROCEDURE eliminar_donacion_componente(
    p_id_donacion_componente IN donacion_componente.id_donacion_componente%TYPE
  );
...
CREATE OR REPLACE PACKAGE BODY pkg_donacion AS
  ...
  BEGIN
    ...
    IF v_count = 0 THEN
      RAISE_APPLICATION_ERROR(-20001, 'La donación especificada no existe');
    END IF;
    
    -- Primero eliminar los componentes relacionados (si los hay)
    DELETE FROM donacion_componente 
    WHERE id_donacion = p_id_donacion;
  ...
  PROCEDURE actualizar_donacion(
    ...
    BEGIN
        ...
        UPDATE donacion 
        SET id_donante          = p_id_donante,
            id_centro           = p_id_centro,
            fecha               = p_fecha,
            volumen_ml          = p_volumen_ml,
            estado              = p_estado,
            id_usuario_registra = p_id_usuario_registra
        WHERE id_donacion = p_id_donacion;
        
        -- Validar actualización
        IF SQL%ROWCOUNT = 0 THEN
            RAISE_APPLICATION_ERROR(-20001, 'La donación especificada no existe o no se pudo actualizar');
        END IF;
    END actualizar_donacion;
  ...
  BEGIN
    ...
    IF v_count = 0 THEN
      RAISE_APPLICATION_ERROR(-20002, 'El componente de donación especificado no existe');
    END IF;
  ...
  END eliminar_donacion_componente;
...
CREATE OR REPLACE PACKAGE pkg_centro_donacion AS
  PROCEDURE validar_actor(p_actor IN usuario.id_usuario%TYPE);
  ...
  PROCEDURE validar_existe_centro(p_id IN centro_donacion.id_centro%TYPE);
  ...
  PROCEDURE obtener(p_id_centro IN centro_donacion.id_centro%TYPE, p_out OUT SYS_REFCURSOR);

  PROCEDURE buscar(p_texto IN VARCHAR2, p_out OUT SYS_REFCURSOR);
...
-- PAQUETE ADMIN
CREATE OR REPLACE PACKAGE PAQ_ADMIN AS
    ...
    -- Procedimientos para gestión de centros
    PROCEDURE REGISTRAR_CENTRO(
        p_nombre IN VARCHAR2,
        p_ubicacion IN VARCHAR2 DEFAULT NULL,
        p_tipo IN VARCHAR2 DEFAULT NULL,
        p_id_centro_out OUT NUMBER
    );
    
    PROCEDURE LISTAR_CENTROS(
        p_cursor OUT SYS_REFCURSOR
    );
    
    PROCEDURE OBTENER_CENTRO(
        p_id_centro IN NUMBER,
        p_cursor OUT SYS_REFCURSOR
    );
    
    PROCEDURE ACTUALIZAR_CENTRO(
        p_id_centro IN NUMBER,
    ...
    PROCEDURE ELIMINAR_CENTRO(
        p_id_centro IN NUMBER
    );
    
    -- Función para obtener estadísticas
    PROCEDURE OBTENER_ESTADISTICAS(
        p_cursor OUT SYS_REFCURSOR
    );
    
    -- Funciones de validación
    FUNCTION FN_USUARIO_EXISTE(p_nombre_usuario VARCHAR2) RETURN NUMBER;
    FUNCTION FN_CENTRO_EXISTE(p_id_centro NUMBER) RETURN NUMBER;
    
END PAQ_ADMIN;
/

-- CUERPO DEL PAQUETE CORREGIDO
CREATE OR REPLACE PACKAGE BODY PAQ_ADMIN AS   
    PROCEDURE REGISTRAR_USUARIO(
        p_nombre_usuario IN VARCHAR2,
        p_contrasena IN VARCHAR2,
        p_correo IN VARCHAR2,
    ...
    BEGIN
        ...
        -- Generar el próximo ID en formato USR###
        SELECT NVL(MAX(TO_NUMBER(SUBSTR(id_usuario, 4))), 0) + 1 
        INTO v_max_num 
        FROM usuario 
        WHERE id_usuario LIKE 'USR%';
        
        p_id_usuario_out := 'USR' || LPAD(v_max_num, 3, '0');
        
        -- Insertar usuario
        INSERT INTO usuario (id_usuario, nombre_usuario, contrasena, correo, id_rol, estado)
        VALUES (p_id_usuario_out, p_nombre_usuario, p_contrasena, p_correo, p_id_rol, p_estado);
    ...
    BEGIN
        ...
        IF p_id_rol IS NOT NULL THEN
            SELECT COUNT(*) INTO v_count FROM rol WHERE id_rol = p_id_rol;
            IF v_count = 0 THEN
                RAISE_APPLICATION_ERROR(-20002, 'El rol especificado no existe');
            END IF;
        END IF;
    ...
    BEGIN
        -- Insertar centro usando la secuencia automática
        INSERT INTO centro_donacion (nombre, ubicacion, tipo)
        VALUES (p_nombre, p_ubicacion, p_tipo)
        RETURNING id_centro INTO p_id_centro_out;
    ...
    BEGIN
        ...
        SELECT COUNT(*) INTO v_count FROM centro_donacion WHERE id_centro = p_id_centro;
        IF v_count = 0 THEN
            RAISE_APPLICATION_ERROR(-20004, 'Centro no encontrado');
        END IF;
        
        -- Actualizar campos no nulos
        UPDATE centro_donacion 
        SET nombre = NVL(p_nombre, nombre),
            ubicacion = NVL(p_ubicacion, ubicacion),
    ...
    BEGIN
        ...
        SELECT COUNT(*) INTO v_count FROM donacion WHERE id_centro = p_id_centro;
        IF v_count > 0 THEN
            RAISE_APPLICATION_ERROR(-20005, 'No se puede eliminar el centro porque tiene donaciones asociadas');
        END IF;
    ...
    BEGIN
        OPEN p_cursor FOR
            SELECT 
                ...
                (SELECT COUNT(*) FROM centro_donacion) as total_centros,
                (SELECT COUNT(*) FROM donante) as total_donantes,
                (SELECT COUNT(*) FROM donacion) as total_donaciones
            FROM dual;
    END OBTENER_ESTADISTICAS;
    
    -- ===== FUNCIONES DE VALIDACIÓN =====
    
    FUNCTION FN_USUARIO_EXISTE(p_nombre_usuario VARCHAR2) RETURN NUMBER AS
        v_count NUMBER;
    BEGIN
    ...
    FUNCTION FN_CENTRO_EXISTE(p_id_centro NUMBER) RETURN NUMBER AS
        v_count NUMBER;
    BEGIN
        SELECT COUNT(*) INTO v_count FROM centro_donacion WHERE id_centro = p_id_centro;
        RETURN v_count;
    END FN_CENTRO_EXISTE;
...
CREATE OR REPLACE PACKAGE BODY PAQ_ADMIN AS   
    PROCEDURE REGISTRAR_USUARIO(
        ...
        p_id_rol IN NUMBER,
        p_estado IN VARCHAR2 DEFAULT 'Activo',
        p_id_usuario_out OUT VARCHAR2  -- Cambiado a VARCHAR2
    ) AS
        v_count NUMBER;
        v_max_num NUMBER;
    BEGIN
    ...
    PROCEDURE ACTUALIZAR_USUARIO(
        p_id_usuario IN VARCHAR2,  -- Cambiado a VARCHAR2
        p_nombre_usuario IN VARCHAR2 DEFAULT NULL,
        p_contrasena IN VARCHAR2 DEFAULT NULL,
        p_correo IN VARCHAR2 DEFAULT NULL,  -- Agregado campo correo
        p_id_rol IN NUMBER DEFAULT NULL,
        p_estado IN VARCHAR2 DEFAULT NULL
    ) AS
        v_count NUMBER;
    ...
    -- ===== GESTI N DE CENTROS (CON COLUMNAS CORRECTAS) =====
    ...
    BEGIN
        ...
        SELECT NVL(MAX(id_centro), 0) + 1 INTO p_id_centro_out FROM centro_donacion;
        
        -- Insertar centro con columnas correctas
        INSERT INTO centro_donacion (id_centro, nombre, ubicacion, tipo)
        VALUES (p_id_centro_out, p_nombre, p_ubicacion, p_tipo);
...
-- Otorgar permisos
GRANT EXECUTE ON PAQ_ADMIN TO PUBLIC;
